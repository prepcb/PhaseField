...
module solution_parameters
  ...
  logical :: init_c=.true.
  logical :: solute,multiphase=.true.
  integer N_phases
...
! parameters for Ni-Cu
  ...
  logical :: heat_c_term=.true.,heat_phi_term=.true.,grad_DW_term=.true.,cross_term=.true.,thermal=.true.
  logical :: g_1D=.false.,folch=.false.,zero_start=.false.
  ...
  double precision :: g_eps22(3,3),g_alpha=0.5
