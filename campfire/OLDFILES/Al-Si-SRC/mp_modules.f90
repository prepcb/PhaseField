...
!!  double precision :: g_L(2)=(/2.35e9,1.728e9/),g_delta(2)=(/2.2e-9 ,2.2e-9 /),g_mu(2)=(/0.0033,0.0039/),g_epsilon(2)
  double precision :: g_M(2),g_sigma(2)=(/0.37,0.29/),g_T(2)=(/933.47,1687./),g_W(2)
  double precision :: g_L(2)=(/2.35e9,4.485654e9/),g_delta(2)=(/2.2e-9 ,2.2e-9 /),g_mu(2)=(/0.0033,0.0039/),g_epsilon(2)
  ...
  double precision ::g_s1,g_s2,g_s3,g_alpha=0d0
!AlSi

double precision ::hlA1(8)=(/3028.879,125.251171,-24.3671976,-0.001884662,-8.77664e-7,74092,7.9337e-20,0/)
double precision ::hlA2(8)=(/-271.21,211.206579,-38.5844296,0.018531982,-5.764227e-6,74092,7.9337e-20,0/)
double precision ::hlA3(8)=(/-795.996,177.430178,-31.748192,0,0,0,0,0/)

double precision ::hlB1(8)=(/42533.751,107.13742,-22.8317533,-0.001912904,-3.552e-9,176667,2.09307e-21,0/)
double precision ::hlB2(8)=(/40370.523,137.722298,-27.196,0,0,0,0,0/)

double precision ::hs1A1(8)=(/-7976.15,137.093038,-24.3671976,-0.001884662,-8.77664e-7,74092,0,0/)
double precision ::hs1A2(8)=(/-11276.24,223.048446,-38.5844296,0.018531982,-5.764227e-6,74092,0,0/)
double precision ::hs1A3(8)=(/-11278.378,188.684153,-31.748192,0,0,0,0,-1.230524e28/)

double precision ::hs1B1(8)=(/42837.391,115.436859,-22.8317533,-0.001912904,-3.552e-9,176667,0,0/)
double precision ::hs1B2(8)=(/41542.358,145.481367,-27.196,0,0,0,0,-4.20369e30/)

double precision ::hs2A1(8)=(/-7976.15,167.093038,-24.3671976,-0.001884662,-8.77664e-7,74092,0,0/)
double precision ::hs2A2(8)=(/-11276.24,253.048446,-38.58442960,0.018531982,-5.764227e-6,74092,0,0/)
double precision ::hs2A3(8)=(/-11278.378,218.684153,-31.748192,0,0,0,0,-1.230524e28/)

double precision ::hs2B1(8)=(/-8162.609,137.2368590,-22.8317533,-0.001912904,-3.552e-9,176667,0,0/)
double precision ::hs2B2(8)=(/-9457.642,167.281367,-27.196,0,0,0,0,-4.20369e30/)

double precision ::hrkl0(2)=(/-11340.1,-1.23394/)
double precision ::hrkl1(2)=(/-3530.93,1.35993/)
double precision ::hrkl2(2)=(/2265.39,0/)

double precision ::hrks10(2)=(/-3143.78, 0.39297/)
double precision ::hrks11(2)=(/0, 0/)
double precision ::hrks12(2)=(/0, 0/)

double precision ::hrks20(2)=(/113246.16, -47.55509/),h_factor=1d0
double precision ::hrks21(2)=(/0d0,0d0/)
double precision ::hrks22(2)=(/0d0,0d0/)
