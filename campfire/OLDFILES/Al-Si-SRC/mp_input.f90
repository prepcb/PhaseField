...
subroutine input_parameter_file_reading()
  ...
  namelist/input_variables/g_sym,defect_tol_min,g_max_lvl,g_output_rate,g_grid,g_nbx,g_nby,g_nbz,AlNi
  namelist/input_variables/ low_vcycle_count,  high_vcycle_count,  max_v_cycle_count, solve_count_max,verbose,h_factor,g_alpha 
