...
module solution_parameters
  ...
  integer :: eighthdmn,g_block,g_shape=1
  double precision :: g_dt,g_dtold,g_amax=0.5,g_hex=1.0
  double precision :: g_df,aspect_ratio=1.0,kinetic_force=0.0,g_xx1=0d0,g_xx0=0d0,g_slope_factor=1d0, g_velocity=1d0,g_Radius_min=80d0,g_mu_infinity=0.5d0
  double precision :: g_Diff0(10,10),g_Diff1(10,10),g_Diff2(10,10),g_d_facets=1d-3
  double precision :: g_mollifier(19,3),g_mol_d=0.2, g_mol_epsilon,g_grid_factor=0.
  integer :: g_mol_n =5
  double precision :: D_therm, A_0,  delta, scale_factor,epsilon, epsilon_tilde,g_x0=0,g_y0=0,g_z0=0d0
  double precision :: D_solute, ke, le, mcinf,T_scale,c_scale,v_mesh,g_hexcol(3,12),g_dodec(3,20), g_TrunOct(3,24),g_obstacle=0d0,g_gamma=0d0,g_cube(3,8)
  double precision :: g_width=0d0
  double precision :: nuc_radius, g_barrier=1d0
  double precision :: anti_trapping_mod=1.0,maxsol=0.0
  logical :: init_c=.true.,g_linear=.true.,New_potential=.false.,g_Wheeler=.false.,g_plapp=.false.,g_parallel_scaling=.false.,g_abs=.false.,g_abs_linear=.false.
  logical :: solute,g_diagonal=.false.,g_triangular=.false.,g_pot_h=.false.
  logical :: g_curve = .false.,paraview=.true.,g_toy_model=.false.,g_no_log_term=.true.,g_antitrapping=.false.,g_multiple=.false.,g_mesh_dependence=.false.
  integer :: N_phases,g_AMM=2,g_order=10, n_sharpen=4
  double precision :: max_x
  double precision :: hsa(3,8),hsb(3,8),hsrk(3,8)
  double precision :: F_time=0d0,dF_time=0d0,inv_time=0d0,g_time=0d0,g_time_end=1d9
...
! parameters for Al-Ni (modified in mp_problem.f90)
  ...
  double precision :: g_L(2)=(/2.35e9,1.728e9/),g_delta(2)=(/2.2e-9 ,2.2e-9 /),g_mu(2)=(/0.0033,0.0039/),g_epsilon(2),g_weight
  double precision :: g_C,g_MolPerVol(2)=(/1.517d5,1.406d5/),g_D(2)=(/1e0,1e-4/) !liquid, solid
  double precision :: g_tau,g_lengthSQ,g_Dch=1d0, g_R = 8.31,g_T0=0d0,g_T_i=0d0,g_d0=5d-10,g_lambda=1.0 !J/(K mol)
  ...
  double precision :: heat_size(4)=0d0,g_c0=0.5,g_D_tilde=1d2,Q_heat(4),sum_heat(4)=0d0,g_beta=0.0,g_Le=100.0,g_max_time=1d6,g_drive=1d0
  ...
  double precision ::g_s1,g_s2,g_s3, g_latent_heat, g_interface, g_infinity = 0.5
  ...
  logical :: g_approx = .false.,g_kinetic=.false.,g_k_mult=.true.,g_skew_potential=.false., g_power_skew=.false.,g_s_skew=.false.,g_dw_skew
  logical :: g_pure = .false.,g_quad_extension=.false.,g_ellipse=.false.,g_equal_delta=.false.,g_needle=.false.,g_AlFe_flag=.true.
  doubleprecision :: g_AlFe_c(2,4)=0d0,g_accel_factor=1d0,g_accel_factor_liq=1d0
  double precision :: g_Sx(27)=(/4./27., -8./27., 4./27., 1./27., -2./27., 1./27., 4./27., -8./27., 4./27., 1./27., -2./27., 1./27., 7./27., -14./27., 7./27., 1./27., -2./27., 1./27., 4./27., -8./27., 4./27., 1./27., -2./27., 1./27., 4./27., -8./27., 4./27./)
  double precision :: g_Sy(27)=(/4./27., 1./27., 4./27., -8./27., -2./27., -8./27., 4./27., 1./27., 4./27., 1./27., 7./27., 1./27., -2./27., -14./27., -2./27., 1./27., 7./27., 1./27., 4./27., 1./27., 4./27., -8./27., -2./27., -8./27., 4./27., 1./27., 4./27./)
  double precision :: g_Sz(27)=(/4./27., 1./27., 4./27., 1./27., 7./27., 1./27., 4./27., 1./27., 4./27., -8./27., -2./27., -8./27., -2./27., -14./27., -2./27., -8./27., -2./27., -8./27., 4./27., 1./27., 4./27., 1./27., 7./27., 1./27., 4./27., 1./27., 4./27./)
