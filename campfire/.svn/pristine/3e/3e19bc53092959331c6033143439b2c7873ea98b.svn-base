...
! parameters for Al-Ni (modified in mp_problem.f90)
  ...
  integer :: g_sym= -1,g_max_lvl=1,g_output_rate=100,g_nbx=1,g_nby=1,g_nbz=1,g_grid,AlNi=2,g_crystal=1
  ...
  double precision ::g_s1,g_s2,g_s3, g_driveforce=1d0,g_max_x=0d0,a_factor=0d0
  logical :: g_kinetic
...
doubleprecision :: g_AlFe_c(2,4)=0d0
...
!!!!!! old models !!!!!!!!
  ...
  double precision ::hc4(8)=(/-63902.6685, 223.595989,-34.586144,0.,0.,0.,0.,2.80962107e30/) 
