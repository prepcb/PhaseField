...
subroutine app_pretimeloop_output(pid, noprocs)
  ...
  if(pid.eq.0.and.chk_chkpt.eq.1) then
     ...
     write(61,'(A13,I12,A5)')   'Model:1,2   ', AlNi
     ...
     write(61,'(A13,L)')        'Hex facet   ',  hex_facet  
     write(61,'(A13,L)')        'FE approx   ',  g_approx  
     write(61,'(A13,L)')        'kinetic anis',  g_kinetic  
     write(61,'(A13,L)')        'mul-T, div-F',  g_k_mult  
     write(61,'(A13,I2)')        'sym:1,-1,0  ',  g_sym
     write(61,'(A13,I2)')        'max level   ',  g_max_lvl
     write(61,'(A13,F12.5)')    'AntiTrapping',  g_alpha
