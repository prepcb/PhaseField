...
#include "paramesh_preprocessor.fh"
      ...
      Subroutine amr_restrict_work_fun(datainw,dataoutw,iopt,i_ind,j_ind)
...
!-----Input/Output arguments.
      ...
      integer, Intent(in)    :: iopt,i_ind,j_ind
...
!-------User defined routine for restriction of 'work' array 
         order=interp_mask_work_res(iopt-1)-20
        Call amr_restrict_work_user(datainw,dataoutw,iopt,order,i_ind,j_ind)
