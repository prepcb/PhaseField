...
#include "paramesh_preprocessor.fh"
      ...
      Subroutine amr_restrict_unk_fun(datain,dataout,i_ind,j_ind)
...
!-----------Call the default interpolation routine for interpolation 
         ...
         ElseIf (interp_mask_unk_res(ivar) >= 20) Then
           ...
           order = interp_mask_unk_res(ivar)-20
            Call amr_restrict_unk_user(datain,dataout,order,ivar,i_ind,j_ind)
