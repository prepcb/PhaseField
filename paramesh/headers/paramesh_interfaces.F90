...
!      subroutine amr_prolong_fc_divbconsist(mype)
      ...
      interface
      subroutine amr_restrict_unk_fun(datain,dataout,i,j)
      ...
      subroutine amr_restrict_unk_user(datain,dataout,order,ivar,i,j)
        real, intent(in)    :: datain(:,:,:,:)
        real, intent(inout) :: dataout(:,:,:,:)
        integer, intent(in) :: order,ivar,i,j
      ...
      interface
      subroutine amr_restrict_work_fun(datain,dataout,iopt,i,j)
      real, intent(in)    :: datain(:,:,:)
      real, intent(inout) :: dataout(:,:,:)
      integer, intent(in) :: iopt,i,j
      ...
      interface
      subroutine amr_restrict_work_user(datain,dataout,iopt,order,i,j)
      real, intent(in)    :: datain(:,:,:)
      real, intent(inout) :: dataout(:,:,:)
      integer, intent(in) :: iopt, order,i,j
      ...
      interface
      subroutine amr_test_refinement(mype,lrefine_min,lrefine_max,initialadapt)
